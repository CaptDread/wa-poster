...
yoda
.to(`.yoda`, {duration: 1.3, y: -10, ease: "linear"})
.to(`.yoda`, {duration:1.3, y:0, ease: "linear"})
.to(`.yoda`, {duration:1.3, y:10, ease: "linear"})
.to(`.yoda`, {duration:1.3, y:0, ease: "linear"})
...
cloak
.to(`.cloak`, {delay: 1.3, duration: 1.3, ease: "linear", skewX:4})
.to(`.cloak`, {duration:1.3, ease: "linear",  skewX:0})
.to(`.cloak`, {duration:1.3, ease: "linear",  skewX:-1})
.to(`.cloak`, {duration:1.3, ease: "linear",  skewX:0})
.to(`.cloak`, {duration: 1.3, ease: "linear", skewX:4})
.to(`.cloak`, {duration:1.3, ease: "linear",  skewX:0})
.to(`.cloak`, {duration:1.3, ease: "linear",  skewX:-1})
.to(`.cloak`, {duration:1.3, ease: "linear",  skewX:0})
